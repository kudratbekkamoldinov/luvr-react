...
//     sweetErrorHandling("Please login first!");
//   };
//   const handleAddCart = async (input: string) => {
...
//                 return (
//                   <SwiperSlide key={index}>
//                     <img className="slider-image" src={imagePath} alt={`Product Image ${index}`} />
//                   </SwiperSlide>
//                 );
//               })}
//             </Swiper>
...
//             <Stack className="product-price">
//               <strong>${chosenProduct.productPrice}</strong>
//               <span>${chosenProduct.productPrice * 0.3 + chosenProduct.productPrice} </span>
//             </Stack>
//             <Stack spacing={2} className="product-sizes">
//               <Box className="sizes-container">
//                 {sizes.map((size) => (
